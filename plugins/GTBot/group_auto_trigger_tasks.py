...
from .GroupAutoTriggerManager import GroupAutoTriggerManager, get_group_auto_trigger_manager
...
async def run_group_auto_trigger_scan(
    *,
    ...
    if effective_runner is None:
        from .ChatCore import config as chat_core_config
        from .ChatCore import run_group_auto_chat_turn
...
async def _group_auto_trigger_job() -> None:
    ...
    from .CacheManager import get_user_cache_manager
